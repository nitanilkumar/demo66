     ...
     <ul class="sidebar-menu do-nicescrol">
      ...
      <li>
        ...
        <ul class="sidebar-submenu">
          <li><a href="{{ route('home') }}"><i class="fa fa-circle-o"></i> Dashboard v11</a></li>
          <li><a href="{{ route('home1') }}"><i class="fa fa-circle-o"></i> Dashboard v2</a></li>
          <li><a href="{{ route('home2') }}"><i class="fa fa-circle-o"></i> Dashboard v3</a></li>
          <li><a href="{{ route('home3') }}"><i class="fa fa-circle-o"></i> Dashboard v4</a></li>
        </ul>
      </li>
      <li>
